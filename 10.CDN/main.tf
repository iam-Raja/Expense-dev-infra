resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              =  "web-${var.environment}.${var.zone_name}"#web-dev.rajapeta.cloud
  ...
  aliases = ["web-${var.common_tags.component}.${var.zone_name}"]#web-cdn.rajapeta.cloud
...
module "records" {
  ...
  records = [
    {
      name    = "web-cdn" #web-cdn.rajapeta.cloud
      type    = "A"
